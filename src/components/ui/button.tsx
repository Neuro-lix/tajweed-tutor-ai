  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-to-r from-gold-warm to-gold-light text-foreground font-semibold shadow-soft hover:shadow-card hover:scale-[1.02]",
        hero: "bg-primary text-primary-foreground font-semibold text-lg px-8 py-4 shadow-card hover:shadow-glow hover:scale-[1.02] transition-all duration-300",
        session: "border-2 border-primary/30 bg-card text-foreground hover:border-primary hover:bg-primary/5 shadow-soft hover:shadow-card transition-all duration-300",
      },
      size: {
